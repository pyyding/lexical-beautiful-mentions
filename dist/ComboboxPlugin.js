...
export function ComboboxPlugin(props) {
    ...
    useEffect(() => {
        ...
        }, COMMAND_PRIORITY_LOW), editor.registerCommand(KEY_ENTER_COMMAND, handleKeySelect, COMMAND_PRIORITY_NORMAL), editor.registerCommand(KEY_TAB_COMMAND, handleKeySelect, COMMAND_PRIORITY_LOW), editor.registerCommand(KEY_BACKSPACE_COMMAND, handleBackspace, COMMAND_PRIORITY_LOW), editor.registerCommand(KEY_DOWN_COMMAND, handleKeyDown, COMMAND_PRIORITY_LOW), editor.registerCommand(FOCUS_COMMAND, handleFocus, COMMAND_PRIORITY_NORMAL), editor.registerCommand(CLICK_COMMAND, () => {
            if (!open) {
                setOpen(true);
            }
            return false;
