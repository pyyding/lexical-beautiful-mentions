...
export default function BeautifulMentionComponent(props) {
    ...
    if (themeValues) {
        return (_jsxs("span", { ref: ref, className: isFocused && !!themeValues.containerFocused
                ...
                : themeValues.container, "data-beautiful-mention": mention, children: [_jsx("span", { className: themeValues.trigger, children: trigger }), _jsx("span", { className: themeValues.value, children: (_a = data === null || data === void 0 ? void 0 : data.mentionLabel) !== null && _a !== void 0 ? _a : value })] }));
    }
