...
function BeautifulMentionComponent(props) {
    ...
    if (themeValues) {
        return ((0, jsx_runtime_1.jsxs)("span", { ref: ref, className: isFocused && !!themeValues.containerFocused
                ...
                : themeValues.container, "data-beautiful-mention": mention, children: [(0, jsx_runtime_1.jsx)("span", { className: themeValues.trigger, children: trigger }), (0, jsx_runtime_1.jsx)("span", { className: themeValues.value, children: (_a = data === null || data === void 0 ? void 0 : data.mentionLabel) !== null && _a !== void 0 ? _a : value })] }));
    }
