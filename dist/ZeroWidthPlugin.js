...
import { $getRoot, $getSelection, $isDecoratorNode, $isRangeSelection, $nodesOfType, COMMAND_PRIORITY_HIGH, KEY_DOWN_COMMAND, LineBreakNode, SELECTION_CHANGE_COMMAND, } from "lexical";
import { useEffect } from "react";
import { $createZeroWidthNode, $isZeroWidthNode, ZeroWidthNode, } from "./ZeroWidthNode";
 ...
 */
export function ZeroWidthPlugin({ textContent }) {
    ...
    useEffect(() => {
        return mergeRegister(editor.registerUpdateListener(() => {
            ...
            return false;
        }, COMMAND_PRIORITY_HIGH), editor.registerCommand(SELECTION_CHANGE_COMMAND, () => {
