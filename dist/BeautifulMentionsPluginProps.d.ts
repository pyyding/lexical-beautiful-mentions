 ...
 * render a menu item.
 */
export type BeautifulMentionsMenuItemProps = Omit<ComponentPropsWithRef<any>, "selected" | "label"> & {
    /**
 ...
 */
export interface BeautifulMentionsComboboxProps extends ComponentPropsWithRef<any> {
    /**
     * If `true`, the `onSearch` function is currently running.
     */
    loading?: boolean;
 ...
 */
export type BeautifulMentionsComboboxItemProps = Omit<ComponentPropsWithRef<any>, "selected" | "option"> & {
    /**
...
type BeautifulMentionsPluginWithCompProps = BeautifulMentionsMenuComponentsProps | BeautifulMentionsMenuCommandComponentProps;
export type BeautifulMentionsSearchProps = BeautifulMentionsPluginWithCompProps & {
    items?: never;
    /**
...
export type BeautifulMentionsItemsProps = BeautifulMentionsPluginWithCompProps & {
    /**
