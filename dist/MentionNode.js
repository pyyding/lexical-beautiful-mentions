...
export class BeautifulMentionNode extends DecoratorNode {
    ...
    decorate(_editor, config) {
        ...
        return (_jsx(MentionComponent, { nodeKey: this.getKey(), trigger: this.getTrigger(), value: this.getValue(), data: this.getData(), className: className, classNameFocused: classNameFocused, classNames: classNames, component: this.component() }));
    }
...
export function $createBeautifulMentionNode(trigger, triggerRegExp, value, data) {
